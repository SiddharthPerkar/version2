...
import { Code2, Rocket, Palette, MessageSquare, ArrowRight, Globe, Zap, Users, Mail, Phone, MapPin, Check, BookOpen, User, Star, Briefcase } from 'lucide-react';
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between h-16 items-center">
            <div className="flex items-center">
              <img src="https://i.imgur.com/YourLogoURL.png" alt="The Webloom Logo" className="h-8 w-auto mr-2" />
              <span className="text-xl font-bold text-[#002366]">The Webloom</span>
            </div>
            <div className="flex gap-6">
              <button 
                onClick={() => setCurrentPage('home')}
                className={`${currentPage === 'home' ? 'text-[#FF0000]' : 'text-gray-600'} hover:text-[#FF0000]`}
              >
                Home
              </button>
              <button 
                onClick={() => setCurrentPage('services')}
                className={`${currentPage === 'services' ? 'text-[#FF0000]' : 'text-gray-600'} hover:text-[#FF0000]`}
              >
                Services
              </button>
              <button 
                onClick={() => setCurrentPage('blog')}
                className={`${currentPage === 'blog' ? 'text-[#FF0000]' : 'text-gray-600'} hover:text-[#FF0000]`}
              >
                Blog
              </button>
              <button 
                onClick={() => setCurrentPage('testimonials')}
                className={`${currentPage === 'testimonials' ? 'text-[#FF0000]' : 'text-gray-600'} hover:text-[#FF0000]`}
              >
                Testimonials
              </button>
              <button 
                onClick={() => setCurrentPage('team')}
                className={`${currentPage === 'team' ? 'text-[#FF0000]' : 'text-gray-600'} hover:text-[#FF0000]`}
              >
                Team
              </button>
              <button 
                onClick={() => setCurrentPage('contact')}
                className={`${currentPage === 'contact' ? 'text-[#FF0000]' : 'text-gray-600'} hover:text-[#FF0000]`}
              >
                Contact
              </button>
            </div>
...
function HomePage() {
  return (
    <>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24">
          <div className="text-center">
            ...
            <p className="text-xl max-w-2xl mx-auto mb-8">
              Elevate your brand with cutting-edge web solutions and innovative digital strategies that bloom into success.
            </p>
            <button className="bg-white text-[#002366] px-8 py-3 rounded-full font-semibold hover:bg-gray-100 transition-colors inline-flex items-center gap-2">
      ...
      <section className="py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="bg-gradient-to-r from-[#002366] to-[#FF0000] rounded-2xl text-white p-12 text-center">
            <h2 className="text-3xl font-bold mb-4">Ready to Bloom?</h2>
            <p className="text-lg mb-8 max-w-2xl mx-auto">
              Let's create something extraordinary together. Your digital success story starts here.
            </p>
            <button className="bg-white text-[#002366] px-8 py-3 rounded-full font-semibold hover:bg-gray-100 transition-colors inline-flex items-center gap-2">
  ...
  return (
    <div className="py-20">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        {/* Process Section */}
        <div className="bg-gray-50 rounded-2xl p-12 mt-12">
...
function TeamPage() {
  return (
    <div className="py-20">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <h1 className="text-4xl font-bold text-center mb-12">Our Leadership Team</h1>
        ...
        <div className="mt-20 text-center">
          ...
          <p className="text-xl text-gray-600 max-w-2xl mx-auto mb-8">
            We're always looking for talented individuals who are passionate about digital innovation and creating exceptional user experiences.
          </p>
